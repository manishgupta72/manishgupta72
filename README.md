...
### Full Stack Developer — RB Tech Solutions
...
![AWS](https://img.shields.io/badge/AWS%20EC2-FF9900?style=flat&logo=amazon-aws&logoColor=white)
![Git](https://img.shields.io/badge/Git-F05032?style=flat&logo=git&logoColor=white)
![Linux](https://img.shields.io/badge/Linux-FCC624?style=flat&logo=linux&logoColor=black)
![Postman](https://img.shields.io/badge/Postman-FF6C37?style=flat&logo=postman&logoColor=white)

**Core CS Concepts**
`System Design` · `Data Structures & Algorithms` · `SOLID Principles` · `Design Patterns` · `Database Normalization` · `Microservices`
...
- 🏅 **Academic Excellence** — Graduated in the Top 5% of the batch with **9.2 CGPA**
- 🏅 **Research & Innovation** — Presented a technical project at the **Aavishkar Research Convention**
- 🏅 Winner of multiple inter-college coding competitions
- 📜 **Advance Certificate in Software Engineering (A.C.S.E.)** — NAVODAYA Skill Development Institute
- 📜 **React JS Certification** — Great Learning Academy
